// apps/webapp/src/routes/BuyerOrderDetail.tsx
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        const res: any = await api<any>(`/orders/${orderId}`);
        ...
        {order.items.map((it, idx) => {
          ...
          const handlePrev = (e: React.MouseEvent) => {
            ...
            setImageIndex((prev) => ({
              ...prev,
              [it.productId]:
                ((safeIndex - 1 + images.length) % images.length) || 0,
            }));
          };
            ...
            >
              ...
              {isExpanded && (
                ...
                >
                  ...
                  {/* NEW: thumbnail strip under main image */}
                  {images.length > 1 && (
                    <div
                      style={{
                        display: "flex",

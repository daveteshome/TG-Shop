// Comprehensive marketplace seeding with R2 image upload
...
const USER_ID = '389755264';

// Product data with Unsplash image URLs
const PRODUCT_DATA = {
  electronics: [
    { title: 'iPhone 14 Pro Max 256GB', price: 85000, desc: 'Brand new, Space Black, 1 year warranty', img: 'https://images.unsplash.com/photo-1678652197831-2d180705aa2c?w=800&q=80' },
  ...
  vehicles: [
    ...
    { title: 'Chevrolet Aveo 2019', price: 720000, desc: 'Affordable and reliable', img: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=800&q=80' },
    { title: 'Peugeot 301 2020', price: 850000, desc: 'French elegance', img: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=800&q=80' },
    { title: 'Renault Logan 2019', price: 680000, desc: 'Spacious interior', img: 'https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2?w=800&q=80' },
    { title: 'Mitsubishi Lancer 2018', price: 920000, desc: 'Sporty sedan', img: 'https://images.unsplash.com/photo-1583121274602-3e2820c69888?w=800&q=80' },
    { title: 'Subaru Impreza 2020', price: 1250000, desc: 'AWD, perfect for Ethiopian roads', img: 'https://images.unsplash.com/photo-1617531653332-bd46c24f2068?w=800&q=80' },
  ],
...
async function createShopWithProducts(
  ...
  for (let i = 0; i < Math.min(productCount, shuffled.length); i++) {
    ...
    try {
      const { imageId, mime } = await downloadAndUploadImage(product.img, shop.id);

      // Create ProductImage with imageId
      ...
      console.log(`    ⚠️  Skipping image for this product`);
    }

    created++;
    if (created % 10 === 0) {
      console.log(`  ✅ Progress: ${created}/${productCount} products created`);
    }
  }
...
async function seedMarketplace() {
  console.log('🌱 Starting comprehensive marketplace seeding with R2 upload...\n');
  ...
  // Generate unique shop names with timestamp
  const timestamp = Date.now();
  const shops = [
    { name: `Addis Electronics ${timestamp}`, slug: `addis-electronics-${timestamp}`, products: 40 },
    { name: `Merkato Motors ${timestamp}`, slug: `merkato-motors-${timestamp}`, products: 35 },
    { name: `Bole Fashion ${timestamp}`, slug: `bole-fashion-${timestamp}`, products: 35 },
  ];
  ...
  console.log(`\n🎉 All shops are live with images!`);
